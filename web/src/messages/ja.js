const japanese = {
  ...
  seo: {
    keywords:
      'ビッグファイブ性格特性テスト、ビッグ5性格特性テスト、b5テスト、ビッグファイブテスト、性格特性、ビッグファイブ、比較、無料、ジョーダンピーターソン'
  },
  frontpage: {
    seo: {
      title: 'BigFive性格特性テスト',
      description:
        'ビッグファイブ性格特性テストを受けてください。'
    },
    title: 'ビッグファイブ性格特性テスト',
    call_to_action: 'テストを受ける',
    no_registration: '',
    tests_taken: '',
    compare: {
      title: '自分を他の人と比較する',
      ...
      text2: '5つの項目で他の人とどのように違うかを学びましょう。',
      action: '実際に動作するのを見る'
    },
    ...
    cards: {
      open: {
        title: 'オープン',
        text: 'MITライセンスの下でのオープンソースプロジェクトです'
      },
      free: {
        title: '無料',
        text: 'テストは完全に無料です'
      ...
      scientific: {
        title: '科学的',
        text: 'BigFiveは科学的に検証された信頼できる心理モデルです'
      },
      translated: {
        title: '翻訳済み',
  ...
  inventory is from <i>Johnson's (2014) 120-item IPIP NEO-PI-R</i>.`,
      info: 'テストには60の質問が含まれており、5分ほどかかります。',
      result:
