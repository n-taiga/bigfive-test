...
export default function Home({ params: { locale } }: Props) {
  ...
  // Toggle comparison UI on/off from a single flag.
  const showCompareSection = false;
  const showLatestPosts = false;
  ...
  return (
    <section className='relative'>
      ...
      <section className='border-divider px-8 mt-16 lg:mt-44 text-center'>
        <div className='my-8'>
      ...
      {showLatestPosts && (
        <div className='text-center mx-2'>
          <LocaleLink href='/articles' className='text-foreground'>
